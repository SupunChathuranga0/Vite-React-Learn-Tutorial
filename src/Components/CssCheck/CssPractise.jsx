...
function CssPractise() {
  ...
  return (
    <div id='wrapper' >
      ...
      <p style={styles_dev1}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus hic quibusdam, accusamus consequuntur architecto placeat fugiat repellendus. Repudiandae earum quod repellat reiciendis consequuntur assumenda atque itaque voluptatum, consequatur quo sit.</p>
    </div>
  )
}
